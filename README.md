...
- **排版规则管理**：
  ...
  - 可自定义字体、段落、间距等详细排版参数
- **专业页眉页脚功能**：
  - **基础设置**：支持页眉页脚内容、字体、字号、对齐方式设置
  - **高级功能**：首页不同、奇偶页不同、三栏布局（左中右）
  - **自动页码**：多种页码位置和格式选择
  - **多节支持**：支持复杂文档的多节页眉页脚配置
  - **实时预览**：配置过程中实时预览页眉页脚效果
...
│   │   │   └── status_panel.py
│   │   ├── dialogs/           # 对话框模块
│   │   │   └── header_footer_dialog.py # 页眉页脚设置对话框
...
3. 页眉页脚配置：
   - 在模板面板中点击"页眉页脚设置"按钮
   - **基础设置**：配置页眉页脚内容、字体、对齐方式
   - **高级设置**：启用首页不同、奇偶页不同、三栏布局
   - **页码设置**：选择页码位置和格式
   - 支持实时预览配置效果
...
4. 页眉页脚问题：
   - 页眉页脚没有显示：检查是否启用了相应选项
   - 页码显示异常：在Word中按F9键更新字段
   - 首页或奇偶页设置无效：确认文档支持相应功能
   - 三栏布局对齐问题：检查内容长度和制表符设置
